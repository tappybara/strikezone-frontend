...
export default class Home extends React.Component {
    constructor(props){
        ...
        this.state = {
            ...
            al_central: [["Chicago", "White Sox", "CHW"], ["Cleveland", "Indians", "CLE"], ["Detroit", "Tigers", "DET"], ["Kansas City", "Royals", "KC"], ["Minnesota", "Twins", "MIN"]],
            ...
            nl_central: [["Chicago", "Cubs","CHC"], ["Cincinnati", "Reds", "CIN"], ["Milwaukee", "Brewers", "MIL"], ["Pittsburgh", "Pirates", "PIT"], ["St.Louis", "Cardinals", "STL"]]
        }
